...
public class Step3Dialog {
	...
	protected Step3Dialog(){
		...
		/*create new dialog*/
	 	JDialog Dia = new JDialog((JFrame)null,"Step3. Setting Config File",true);
		...
		Dia.setLocation(xpos, ypos);
	 	...
	 	/*announcement */
	 	JLabel l1 = new JLabel("Setting Config File");
	...
	private JScrollPane contentpane(){
		  ...
		  JLabel advancedL = new JLabel("Show Advanced Setting                                                                                                                                       ");
		  ...
		  JLabel showtrainconfigL = new JLabel("Show Path Detail of Input Reader                                                                                                                                       ");
		  ...
		  String[] metrics_settypes ={"coco_detection_metrics", "coco_mask_metrics",
		  ...
		  JLabel showPathL = new JLabel("Show Path Detail of Input Reader                                                                                                                                       ");
	...
	private void initdata(){
		...
		String pathToObjDetec = "/home/"+Model.username+"/tensorflowGUI/"+Model.ActivatedEnv+"/models/research/object_detection";
		String fine_tune_checkpoint = 
				  pathToObjDetec + "/faster_rcnn_inception_v2_coco_2018_01_28/model.ckpt";
	...
	private void exportdata(){
		...
		sshclient.sendCommand("cd /home/"+Model.username+"/tensorflowGUI/scripts "
								+ "&& bash setconfig.sh "
								+ Model.ActivatedEnv +" "
								+ parameters);
